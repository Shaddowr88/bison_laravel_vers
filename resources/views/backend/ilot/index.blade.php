    ...
    <div class="col-xl-12 col-md-6 mb-4">
        ...
        <div class="row">
            <div class="col-12 mb-2 ">
                <div>
                        <div class="row">
                            <div class="ml-lg-3 mt-3 row-cols-12 text-left">
...
{{--                    Liste de batiment s'il en à au moins 1--}}
                    @if (count($batiments) > 0)
                        <div class=" fixed-top mt-lg-5 mr-lg-5 " >
                            <a class=" btn float-lg-right "  href="{{route('backend_add')}}">
                                <ion-icon name="add-circle-outline" size="large" data-toggle="tooltip" data-placement="left" title="Ajouter un nouveau bâtiment" ></ion-icon>
                            </a>
                        </div>
...
{{--                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>--}}
    ...
    <style>
        ...
        #mycard:before, #mycard:after
        {
            ...
            box-shadow:5px 10px 30px rgb(33,188,249);;
            top:50%;
            bottom:0;
            left:10px;
            right:10px;
